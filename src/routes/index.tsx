    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-30 border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-8 text-sm text-muted-foreground md:flex">
            ...
            <a href="#precos" className="hover:text-foreground">Planos</a>
          </nav>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16 pt-20 text-center">
        ...
        <h1 className="mt-10 font-display text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
          ...
          <span className="text-gradient-primary">organizar a rotina</span>,
          acelerar aprovações e reduzir o trabalho manual na hora de publicar.
        </h1>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              São briefings soltos no WhatsApp, gambiarra no Trello, links perdidos no Drive
              e feedbacks espalhados por print de conversa. Enquanto isso, o cliente nem
              sabe onde aprovar, pede 7 alterações, e você ainda precisa avisar o designer
              e ajustar a legenda que ficou perdida em uma das 5 abas abertas.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-3">
            {["WhatsApp lotado","Trello bagunçado","Drive perdido","Prints de feedback","Abas demais","Cliente confuso"].map((t) => (
      ...
      <section id="recursos" className="mx-auto max-w-6xl px-6 py-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            ...
            clientes, equipe, tarefas e financeiro.
          </p>
        </div>

        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {modules.map((m) => (
            <div key={m.label} className="group rounded-2xl border border-border bg-card p-6 shadow-card transition hover:-translate-y-0.5 hover:shadow-soft">
      ...
      <section id="fluxo" className="border-t border-border/60 bg-muted/40 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            <h2 className="font-display text-3xl font-semibold md:text-4xl">Do briefing ao publicado</h2>
            <p className="mt-3 text-muted-foreground">Um fluxo claro que respeita o ritmo do cliente e da equipe.</p>
          </div>
      ...
      <section id="precos" className="mx-auto max-w-4xl px-6 py-20 text-center">
        <div className="rounded-3xl bg-chip-dark p-10 md:p-14">
          ...
          <Button asChild size="lg" className="mt-8 h-12 px-8 text-base">
            <Link to="/auth">Criar conta agora <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </section>
